...
async def start(event):
    await event.reply("Hello, I'm a bot to search chats and channels from given query!", buttons=[Button.url("Source", "https://t.me/HEROKUFREECC"), Button.url("ADMIN", "https://t.me/iam_daxx")])
